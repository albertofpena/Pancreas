...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageProcessor_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 84, 15)
    },
    "ImageProcessor\0outputSliceTransformation\0"
    "\0vtkPasteSliceIntoVolumeInsertSliceParams*\0"
    "insertionParams"
};
...
void ImageProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->outputSliceTransformation((*reinterpret_cast< vtkPasteSliceIntoVolumeInsertSliceParams*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ImageProcessor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ImageProcessor.data,
      qt_meta_data_ImageProcessor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageProcessor.stringdata))
